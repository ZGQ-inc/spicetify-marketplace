...
echo "安装 SpotX..."
bash -c "curl -sSL https://raw.githubusercontent.com/SpotX-Official/SpotX-Bash/main/spotx.sh | bash -s - -d -e"

echo "安装 Spicetify..."
bash -c "curl -fsSL https://raw.githubusercontent.com/spicetify/cli/main/install.sh | sh"
